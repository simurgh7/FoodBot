...
def main():
    ...
    # Load Cross-ViT model
    model = timm.create_model('crossvit_9_dagger_240.in1k', pretrained=True, num_classes=10)
    model.to(device)
    ...
    torch.save(model.state_dict(), r'/media/aanisha/484C1AEF4C1AD810/Users/mehza/OneDrive - University of South Florida/study(USF)/coursework/2409-CIS6930-Trustworthy-AI-Systems/Final-Project/weight/crossvit.pth')
