...
def main():
    ...
    torch.save(model.state_dict(), r'/media/aanisha/484C1AEF4C1AD810/Users/mehza/OneDrive - University of South Florida/study(USF)/coursework/2409-CIS6930-Trustworthy-AI-Systems/Projects/weight/pvt_v2_b1.pth')
