...
def main():
    ...
    # Load pretrained ViT model with 10 output classes (your case)
    ...
    torch.save(model.state_dict(), r'/media/aanisha/484C1AEF4C1AD810/Users/mehza/OneDrive - University of South Florida/study(USF)/coursework/2409-CIS6930-Trustworthy-AI-Systems/Projects/weight/vit_16_224.pth')
