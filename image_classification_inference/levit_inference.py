...
model = timm.create_model('levit_conv_128.fb_dist_in1k', pretrained=True, num_classes=10)
model.load_state_dict(torch.load(r'../weight/levit_conv.pth', map_location=device))
model.to(device)
