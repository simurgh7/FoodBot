...
model = timm.create_model('maxvit_tiny_rw_224.sw_in1k', pretrained=False, num_classes=10)
model.load_state_dict(torch.load(r'../weight/maxvit_tiny_224.pth', map_location=device))
model.to(device)
...
# Example usage
image_path = '../../Data/test/banh-pia/43.jpg'
