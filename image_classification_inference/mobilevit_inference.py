...
model = timm.create_model('mobilevit_s.cvnets_in1k', pretrained=True, num_classes=10)
model.load_state_dict(torch.load(r'../weight/mobilevit_cvnet.pth', map_location=device))
model.to(device)
