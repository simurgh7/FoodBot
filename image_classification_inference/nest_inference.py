...
model = timm.create_model('nest_base_jx.goog_in1k', pretrained=True, num_classes=10)
model.load_state_dict(torch.load(r'../weight/nest_base.pth', map_location=device))
model.to(device)
...
# Example usage
image_path = '/media/aanisha/484C1AEF4C1AD810/Users/mehza/OneDrive - University of South Florida/study(USF)/coursework/Fall24-CIS6930-Trustworthy-AI-Systems/Data/test/banh-pia/43.jpg'
